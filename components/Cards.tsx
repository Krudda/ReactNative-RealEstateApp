  ...
  return (
    <TouchableOpacity onPress={onPress} className="flex flex-col items-start w-60 h-80 relative">
      ...
      <View className="flex-col items-start absolute bottom-5 inset-x-5">
        ...
        <Text className="text-base font-rubik text-white">22 W 15th Str., New York</Text>
  ...
  return (
    ...
    >
      ...
      <View className="flex-col mt-2">
        ...
        <Text className="text-xs font-rubik text-black-200">22 W 15th Str., New York</Text>

        <View className="flex-row items-center justify-between mt-2">
          <Text className="text-base font-rubik-bold text-primary-300">$1.200</Text>
